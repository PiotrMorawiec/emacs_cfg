...
=Some usefull commands / key bingings=

| KEYCHORD | COMMAND        | INFO                                                         |
|----------+----------------+--------------------------------------------------------------|
| C-c C-j  | term-line-mode | Commands (e.g. C-c) will be interpereted as Emacs commands   |
| C-c C-k  | term-char-mode | Commands (e.g. C-c) will be interpreted as terminal commands |
| C-c C-p  |                | Go back in the buffer's prompts                              |
| C-c C-n  |                | Go forward in the buffer's prompts                           |
|          |                |                                                              |
